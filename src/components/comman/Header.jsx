...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className='flex flex-col justify-center pl-9 rounded-full hover:bg-gray-100 cursor-pointer group'>
        <p className='text-xs font-medium pl-2'>Where</p>
        <input type="text" placeholder='Search destinations' className='text-gray-500 group-hover:bg-gray-100 cursor-pointer rounded-full focus:outline-none pl-2'/>
      </div>
